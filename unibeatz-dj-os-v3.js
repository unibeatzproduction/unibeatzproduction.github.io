...
(function(){
  ...
  function attach(){
    ...
    OS.util.notify(
      names ? `DJ controller connected: ${names}` : 'MIDI permission granted, but no controller input is exposed.',
      names ? '#5dff9e' : '#F0C040'
    );
  }
...
(function(){
  ...
  function build(){
    ...
    panel.innerHTML=`
      ...
      <div class="title">UniBeatz DJ Controller</div>
      <div class="sub">DJ controller input · MIDI + HID · Learn Mode · Radio + Battle · cloud mappings</div>
      <div class="row">
        <button id="ubDjOSMidi" class="gold" type="button">CONNECT DJ CONTROLLER</button>
...
console.log('[UniBeatz DJ Controller] V4 single-controller-owner build loaded');
