...
(function(){
  ...
  function liveRoleForSlot(slot){
    if(slot === 'practice') return 'practice';
    if(slot === 'artist2' || slot === 'teamB1' || slot === 'teamB2') return 'artist2';
    return 'artist1';
  }

  function makeSlotTile(slot){
    var tile = document.createElement('div');
    tile.id = slot === 'teamA1' || slot === 'artist1' ? 'artist1Video' : slot === 'teamB1' || slot === 'artist2' ? 'artist2Video' : 'battleSlot_' + slot;
  ...
  function openMode(key){
    ...
    var round = page.querySelector('#ubBattleRoundInfo');
