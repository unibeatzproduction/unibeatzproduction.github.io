...
(function(){
  ...
  function styleProfileVideo(vid, local){
    ...
    vid.style.cssText='position:absolute;inset:0;width:100%;height:100%;object-fit:cover;background:#000;'+(local?'transform:scaleX(-1);':'');
  }
  ...
  function ensureLiveModal(){
    ...
    m.innerHTML='<div style="max-width:1000px;margin:0 auto;"><button id="ubLiveClose" class="btn btn-gold" style="width:auto;margin-bottom:12px;">← CLOSE</button><div id="ubLiveHeader"></div><div style="display:grid;grid-template-columns:minmax(0,2fr) minmax(280px,1fr);gap:12px;"><div id="ubLiveVideoBox" style="min-height:320px;border-radius:14px;border:1px solid rgba(64,208,255,.45);background:#05070d;display:flex;align-items:center;justify-content:center;color:#40D0FF;font-family:Orbitron,sans-serif;font-size:.55rem;">CONNECTING...</div><div style="border-radius:14px;border:1px solid rgba(201,168,76,.45);background:rgba(0,0,0,.35);padding:12px;"><div style="font-family:Orbitron,sans-serif;color:#40D0FF;font-size:.55rem;letter-spacing:2px;margin-bottom:8px;">LIVE CHAT</div><div id="ubLiveChatList" style="height:245px;overflow:auto;border:1px solid rgba(255,255,255,.08);border-radius:10px;padding:8px;margin-bottom:8px;"></div><input id="ubLiveChatInput" placeholder="Talk live..." style="width:100%;padding:10px;border-radius:8px;border:1px solid rgba(64,208,255,.5);background:#05070d;color:#fff;margin-bottom:8px;"><button id="ubLiveSend" class="btn btn-blue">SEND CHAT</button></div></div></div>';
