...
(function(){
  ...
  function ensureLiveModal(){
    ...
    m.innerHTML=[
      '<div style="max-width:600px;margin:0 auto;">',
        ...
        '<div id="ubLiveVideoBox" style="width:100%;border-radius:14px;border:2px solid rgba(255,51,51,.6);background:#000;position:relative;overflow:hidden;aspect-ratio:9/16;max-height:60vh;margin-bottom:12px;">',
  ...
  function renderProfile(){
    ...
    _lastProfileKey=key;
    // Don't wipe profile if live cam box is active
    if(document.getElementById('ubProfileLiveCamBox')) return;
